...
# ])
#
# test_dataset = TumorDataset(image_folder='real_dataset/test', sigma=50, transform=test_transform)
# dataloader_test  = DataLoader(test_dataset, batch_size=1, shuffle=False, num_workers=0)
#
# train_dataset = TumorDataset(image_folder='real_dataset/test', sigma=50,transform=test_transform)
