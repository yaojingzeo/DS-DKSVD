...
from test import *
from model import DS_DKSVD_cla
...
def main(rank, world_size):
    ...
    # 创建训练集和测试集的Dataset对象
    train_dataset = TumorDataset(image_folder='/media/diplab/US100 2TB/DS-DKSVD/Classificiation/real_dataset/train', transform=train_transform)
    ...
    val_dataset = TumorDataset(image_folder='/media/diplab/US100 2TB/DS-DKSVD/Classificiation/real_dataset/val',  transform=test_transform)
    dataloader_val  = DataLoader(val_dataset, batch_size=1, shuffle=False, num_workers=0)

    test_dataset = TumorDataset(image_folder='/media/diplab/US100 2TB/DS-DKSVD/Classificiation/real_dataset/test', transform=test_transform)
